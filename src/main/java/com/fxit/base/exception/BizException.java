...
public class BizException extends RuntimeException {
    ...
    public BizException(IBizError error, String extendMessage) {
        this(error.getCode(), error.getBizCode(), error.getMessage() + ": " + extendMessage, error.getLevel(), new Throwable());
    }

    public BizException(IBizError error, Throwable throwable) {
        this(error.getCode(), error.getBizCode(), error.getMessage(), error.getLevel(), throwable);
    }
